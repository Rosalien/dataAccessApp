...
RUN apt-get update && apt-get install -y  git-core imagemagick libcurl4-openssl-dev libgit2-dev libpng-dev libssh2-1-dev libssl-dev libxml2-dev make pandoc pandoc-citeproc zlib1g-dev && rm -rf /var/lib/apt/lists/*
...
EXPOSE 80
CMD R -e "options('shiny.port'=80,shiny.host='0.0.0.0');dataAccessApp::run_app()"
